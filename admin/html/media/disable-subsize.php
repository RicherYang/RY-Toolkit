...
<fieldset>
    ...
    <label for="ry_disable_subsize_<?php echo esc_attr($size_name); ?>">
        <input name="<?php echo esc_attr(Main::get_prefix_name('disable_subsize')); ?>[]" type="checkbox" id="ry_disable_subsize_<?php echo esc_attr($size_name); ?>" value="<?php echo esc_attr($size_name); ?>" <?php checked(in_array($size_name, $disable_subsize)); ?>>
