<fieldset>
    <legend class="screen-reader-text"><span><?php esc_html_e('Medium large size', 'ry-tools'); ?></span></legend>
    <label for="medium_large_size_w"><?php esc_html_e('Max Width', 'ry-tools'); ?></label>
    ...
    <br />
    <label for="medium_large_size_h"><?php esc_html_e('Max Height', 'ry-tools'); ?></label>
